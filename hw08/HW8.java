...
public class HW8{ //open the class of program 
...
public static String getInput(Scanner scan, String string){
    ...
    string=scan.next(); //accept input 
    
    if (string.equals("C") || string.equals("c")){ //accept C or c, nothing else
        return string;
    }
    else{ 
    System.out.println("Yea right LOSER!"); //output for not entering C or c
    System.exit(1);
    return string;
    }
}//close method 4. 
